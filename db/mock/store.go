...
// Source: github.com/StevenSopilidis/BackendMasterClass/db/sqlc (interfaces: Store)
...
func (m *MockStore) TransferTx(arg0 context.Context, arg1 db.TrasferTxParams) (db.TrasferTxResult, error) {
	m.ctrl.T.Helper()
