...
import (
	...
	mockdb "github.com/StevenSopilidis/BackendMasterClass/db/mock"
...
func TestCreateAccountApi(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			name: "Invalid currency provided",
			requestBody: gin.H{
				"owner":    account.Owner,
				"currency": "sdaadfafsd",
			},
...
func TestGetAccountApi(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			buildStubs: func(store *mockdb.MockStore) {
				// expect GetAccount method to be called with any as first argument
				// and with the accont.ID as the second argument
				store.EXPECT().
